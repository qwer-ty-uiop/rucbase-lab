...
class InterpForTest {
   ...
   public:
    InterpForTest(SmManager *sm_manager, QlManager *ql_manager) : sm_manager_(sm_manager), ql_manager_(ql_manager) {}

    void interp_sql(const std::shared_ptr<ast::TreeNode> &root, Context *context) {
