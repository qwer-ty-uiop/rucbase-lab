...
int main() {
    std::vector<std::string> sqls = {
        ...
        "select x.a, y.b from x left outer join y on x.a = y.b;",
        "select x.a, y.b from x right outer join y on x.a = y.b;",
        "select x.a, y.b from x cross join y;",
        "select x.a, y.b from x join y;",
        "select x.a, y.b from x inner join y;",
        "select x.a, y.b from x left join y;",
        "select x.a, y.b from x right join y;",
        "select x.a, y.b from x join y on x.a = y.b where c = d;",
        "select x.a, y.b from x inner join y on x.a = y.b where c = d;",
        "select x.a, y.b from x left join y on x.a = y.b where c = d;",
        "exit;",
        "help;",
        "",
    };
